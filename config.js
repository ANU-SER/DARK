...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By 𝐀𝐍𝐒𝐇𝐈𝐃' : process.env.ALL_CAPTION,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/P47w0P3.jpeg' : process.env.GAN_IMAGE,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ᵃⁿˢʰⁱᵈ࿐' : process.env.BOT_NAME,
    ...
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/splrlt_ser/' : process.env.SOCIAL_MEDIA,
