...
if (Config.WORKTYPE == 'private') {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '*𝐌𝐀𝐃𝐄 𝐁𝐘 𝐀𝐍𝐒𝐇𝐈𝐃*'})
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '*𝐌𝐀𝐃𝐑 𝐁𝐘 𝐀𝐍𝐒𝐇𝐈𝐃*'})
